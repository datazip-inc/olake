...
// ReformatColumnName conditionally reformats column names based on the CaseSensitiveColumnNames configuration.
func ReformatColumnName(key string) string {
	if !viper.GetBool(constants.CaseSensitiveColumnNames) {
