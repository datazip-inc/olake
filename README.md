...
|----------------------|--------------------------|--------------------------------------|--------------------------------------------------------------|
| Postgres → Iceberg   | 457 RPS (Full load)      | 699.2× faster than Airbyte Cloud     | [Full Report](https://olake.io/docs/benchmarks?tab=postgres) |
| MySQL → Iceberg      | 64,334 RPS (Full load)   | 9× faster than Airbyte Cloud          | WIP                                                          |
| MongoDB → Iceberg    | WIP                      |                                      |                                                              |
| Oracle → Iceberg     | WIP                      |                                      |                                                              |
