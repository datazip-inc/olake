...
- Modify Each Stream:<br>
   ...
   > Note: For incremental sync to work correctly, newly inserted records should have cursor values greater than the previously synced maximum value of both primary and fallback cursor fields (since the system stores the maximum of both cursors in the state).
   ```json
