...
<br> The `append_only` flag determines whether records can be written to th iceberg delete file. If set to true, no records will be written to the delete file<br>
   ```json
   {
      "selected_streams": {
         "public": [
