...
func addTestTableData(ctx context.Context, t *testing.T, conn interface{}, table string, numItems int, startAtItem int, cols ...string) {
	...
	allCols := []string{
		...
		"col_char", "col_character", "col_character_varying", "col_daterange",
		"col_double_precision", "col_float4", "col_float8", "col_inet", "col_int2",
...
func insertOp(ctx context.Context, t *testing.T, conn interface{}, tableName string) {
	...
	query := fmt.Sprintf(`
		INSERT INTO %s (
			...
			col_box, col_bpchar, col_char, col_character, col_character_varying,
			col_daterange, col_double_precision, col_float4, col_float8, 
...
func updateOp(ctx context.Context, t *testing.T, conn interface{}, tableName string) {
	...
	query := fmt.Sprintf(`
		...
		SET 
			...
			col_character_varying = 'updated_varchar',
			col_daterange = '[2024-02-01,2024-02-20]',
			col_double_precision = 55.5,
			col_float4 = 65.5,
			col_float8 = 75.5,
