...
const (
	// minCDCInitialWaitTime is the minimum wait time in seconds for CDC synchronization.
	minCDCInitialWaitTime = 120
	// defaultCDCInitialWaitTime is the default wait time in seconds for CDC synchronization.
