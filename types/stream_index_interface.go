...
func (b *StreamIndexThread) Delete(key string) {
	b.changes[key] = streamIndexChange{deleted: true}
}
...
func (b *StreamIndexThread) Range(fn func(key string, loc RowLocation, deleted bool) error) error {
