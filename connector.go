...
import (
	...
	_ "github.com/datazip-inc/olake/writers/parquet"    // registering raw parquet writer
	_ "github.com/datazip-inc/olake/writers/parquet-go" // registering local writer
)
