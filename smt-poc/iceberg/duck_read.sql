...
SELECT order_id, customer_email, doc.customer.addr.city AS city, doc.items[1].sku AS first_sku, variant_typeof(doc) AS t FROM ice.demo.arrow_variant ORDER BY order_id;
