...
func ExecuteQuery(ctx context.Context, t *testing.T, conf *testutils.TestConfig, operation string) {
	...
	case "update":
        ...
        UPDATE %s SET
            col_cursor = NULL,
            col_smallint = 321,
			col_timestamp = TIMESTAMP('2024-01-01-12.00.00.573605'),
			excludedColumn = 102,
			includedColumn = 202
...
var ExpectedUpdatedDB2Data = map[string]interface{}{
	...
	"col_clob":       "sample text",
	"col_blob":       "BLOB DATA ONE",
	"col_timestamp":  arrow.Timestamp(time.Date(2024, 1, 1, 12, 0, 0, 573605000, time.UTC).UnixNano() / int64(time.Microsecond)),
	"col_time":       "12:00:00",
	"col_graphic":    "graphic_val",
	"col_vargraphic": "vargraphic_val",
