...
public final class ArrowIngestServiceGrpc {
  ...
  public static final String SERVICE_NAME = "io.olake.iceberg.rpc.ArrowIngestService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<io.olake.iceberg.rpc.RecordIngest.ArrowPayload,
      io.olake.iceberg.rpc.RecordIngest.ArrowIngestResponse> getIcebergAPIMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "IcebergAPI",
      requestType = io.olake.iceberg.rpc.RecordIngest.ArrowPayload.class,
      responseType = io.olake.iceberg.rpc.RecordIngest.ArrowIngestResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.olake.iceberg.rpc.RecordIngest.ArrowPayload,
      io.olake.iceberg.rpc.RecordIngest.ArrowIngestResponse> getIcebergAPIMethod() {
    io.grpc.MethodDescriptor<io.olake.iceberg.rpc.RecordIngest.ArrowPayload, io.olake.iceberg.rpc.RecordIngest.ArrowIngestResponse> getIcebergAPIMethod;
      ...
      synchronized (ArrowIngestServiceGrpc.class) {
        if ((getIcebergAPIMethod = ArrowIngestServiceGrpc.getIcebergAPIMethod) == null) {
          ArrowIngestServiceGrpc.getIcebergAPIMethod = getIcebergAPIMethod =
              io.grpc.MethodDescriptor.<io.olake.iceberg.rpc.RecordIngest.ArrowPayload, io.olake.iceberg.rpc.RecordIngest.ArrowIngestResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "IcebergAPI"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.olake.iceberg.rpc.RecordIngest.ArrowPayload.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.olake.iceberg.rpc.RecordIngest.ArrowIngestResponse.getDefaultInstance()))
  ...
  public static abstract class ArrowIngestServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void icebergAPI(io.olake.iceberg.rpc.RecordIngest.ArrowPayload request,
        io.grpc.stub.StreamObserver<io.olake.iceberg.rpc.RecordIngest.ArrowIngestResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.olake.iceberg.rpc.RecordIngest.ArrowPayload,
                io.olake.iceberg.rpc.RecordIngest.ArrowIngestResponse>(
  ...
  public static final class ArrowIngestServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ArrowIngestServiceBlockingStub> {
    ...
    /**
     */
    public io.olake.iceberg.rpc.RecordIngest.ArrowIngestResponse icebergAPI(io.olake.iceberg.rpc.RecordIngest.ArrowPayload request) {
  ...
  public static final class ArrowIngestServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ArrowIngestServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.olake.iceberg.rpc.RecordIngest.ArrowIngestResponse> icebergAPI(
        io.olake.iceberg.rpc.RecordIngest.ArrowPayload request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ICEBERG_API:
          serviceImpl.icebergAPI((io.olake.iceberg.rpc.RecordIngest.ArrowPayload) request,
              (io.grpc.stub.StreamObserver<io.olake.iceberg.rpc.RecordIngest.ArrowIngestResponse>) responseObserver);
          break;
        default:
