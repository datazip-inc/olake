...
public final class TableIndexServiceGrpc {
  ...
  public static final String SERVICE_NAME = "io.olake.iceberg.rpc.TableIndexService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<io.olake.iceberg.rpc.RecordIngest.TableIndexScanRequest,
      io.olake.iceberg.rpc.RecordIngest.TableIndexScanBatch> getScanTableForIndexingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ScanTableForIndexing",
      requestType = io.olake.iceberg.rpc.RecordIngest.TableIndexScanRequest.class,
      responseType = io.olake.iceberg.rpc.RecordIngest.TableIndexScanBatch.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<io.olake.iceberg.rpc.RecordIngest.TableIndexScanRequest,
      io.olake.iceberg.rpc.RecordIngest.TableIndexScanBatch> getScanTableForIndexingMethod() {
    io.grpc.MethodDescriptor<io.olake.iceberg.rpc.RecordIngest.TableIndexScanRequest, io.olake.iceberg.rpc.RecordIngest.TableIndexScanBatch> getScanTableForIndexingMethod;
      ...
      synchronized (TableIndexServiceGrpc.class) {
        if ((getScanTableForIndexingMethod = TableIndexServiceGrpc.getScanTableForIndexingMethod) == null) {
          TableIndexServiceGrpc.getScanTableForIndexingMethod = getScanTableForIndexingMethod =
              io.grpc.MethodDescriptor.<io.olake.iceberg.rpc.RecordIngest.TableIndexScanRequest, io.olake.iceberg.rpc.RecordIngest.TableIndexScanBatch>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ScanTableForIndexing"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.olake.iceberg.rpc.RecordIngest.TableIndexScanRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.olake.iceberg.rpc.RecordIngest.TableIndexScanBatch.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.olake.iceberg.rpc.RecordIngest.MigrateEqualityDeletesRequest,
      io.olake.iceberg.rpc.RecordIngest.MigrateEqualityDeletesResponse> getMigrateEqualityDeletesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MigrateEqualityDeletes",
      requestType = io.olake.iceberg.rpc.RecordIngest.MigrateEqualityDeletesRequest.class,
      responseType = io.olake.iceberg.rpc.RecordIngest.MigrateEqualityDeletesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.olake.iceberg.rpc.RecordIngest.MigrateEqualityDeletesRequest,
      io.olake.iceberg.rpc.RecordIngest.MigrateEqualityDeletesResponse> getMigrateEqualityDeletesMethod() {
    io.grpc.MethodDescriptor<io.olake.iceberg.rpc.RecordIngest.MigrateEqualityDeletesRequest, io.olake.iceberg.rpc.RecordIngest.MigrateEqualityDeletesResponse> getMigrateEqualityDeletesMethod;
      ...
      synchronized (TableIndexServiceGrpc.class) {
        if ((getMigrateEqualityDeletesMethod = TableIndexServiceGrpc.getMigrateEqualityDeletesMethod) == null) {
          TableIndexServiceGrpc.getMigrateEqualityDeletesMethod = getMigrateEqualityDeletesMethod =
              io.grpc.MethodDescriptor.<io.olake.iceberg.rpc.RecordIngest.MigrateEqualityDeletesRequest, io.olake.iceberg.rpc.RecordIngest.MigrateEqualityDeletesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MigrateEqualityDeletes"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.olake.iceberg.rpc.RecordIngest.MigrateEqualityDeletesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.olake.iceberg.rpc.RecordIngest.MigrateEqualityDeletesResponse.getDefaultInstance()))
  ...
  public static abstract class TableIndexServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void scanTableForIndexing(io.olake.iceberg.rpc.RecordIngest.TableIndexScanRequest request,
        io.grpc.stub.StreamObserver<io.olake.iceberg.rpc.RecordIngest.TableIndexScanBatch> responseObserver) {
     ...
     * </pre>
     */
    public void migrateEqualityDeletes(io.olake.iceberg.rpc.RecordIngest.MigrateEqualityDeletesRequest request,
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                io.olake.iceberg.rpc.RecordIngest.TableIndexScanRequest,
                io.olake.iceberg.rpc.RecordIngest.TableIndexScanBatch>(
  ...
  public static final class TableIndexServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<TableIndexServiceBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<io.olake.iceberg.rpc.RecordIngest.TableIndexScanBatch> scanTableForIndexing(
        io.olake.iceberg.rpc.RecordIngest.TableIndexScanRequest request) {
     ...
     * </pre>
     */
    public io.olake.iceberg.rpc.RecordIngest.MigrateEqualityDeletesResponse migrateEqualityDeletes(io.olake.iceberg.rpc.RecordIngest.MigrateEqualityDeletesRequest request) {
  ...
  public static final class TableIndexServiceFutureStub extends io.grpc.stub.AbstractFutureStub<TableIndexServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<io.olake.iceberg.rpc.RecordIngest.MigrateEqualityDeletesResponse> migrateEqualityDeletes(
        io.olake.iceberg.rpc.RecordIngest.MigrateEqualityDeletesRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SCAN_TABLE_FOR_INDEXING:
          serviceImpl.scanTableForIndexing((io.olake.iceberg.rpc.RecordIngest.TableIndexScanRequest) request,
              (io.grpc.stub.StreamObserver<io.olake.iceberg.rpc.RecordIngest.TableIndexScanBatch>) responseObserver);
          break;
  ...
  private static abstract class TableIndexServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.olake.iceberg.rpc.RecordIngest.getDescriptor();
    }
