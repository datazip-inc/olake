...
import io.olake.iceberg.SchemaConvertor;
...
import io.olake.iceberg.tableoperator.RecordWrapper;
...
public class OlakeRowsIngester extends RecordIngestServiceGrpc.RecordIngestServiceImplBase {
        ...
        try {
            ...
            switch (request.getType()) {
                ...
                case RECORDS:
                    ...
                    sendResponse(responseObserver, io.olake.iceberg.rpc.RecordIngest.RecordIngestResponse.newBuilder()
    ...
    private void sendResponse(StreamObserver<RecordIngest.RecordIngestResponse> responseObserver, io.olake.iceberg.rpc.RecordIngest.RecordIngestResponse response) {
    ...
    private Table loadOrCreateTable(TableIdentifier tableId, Schema schema, List<Map<String, String>> partitionTransforms,
        ...
        try {
            ...
            String errorMessage = String.format("Failed to create table %s from record schema. Error: %s",
