...
public class OlakeRpcServer {
     ...
     // List to store partition fields and their transforms - preserves order and
     // allows duplicates
     ...
     public static void main(String[] args) throws Exception {
          ...
          if (configMap.containsKey("partition-fields")) {
               List<Map<String, String>> partitionFieldsList = (List<Map<String, String>>) configMap
          ...
          // Log server startup without exposing potentially sensitive configuration
          // details
