...
type IcebergPayload_Metadata struct {
	...
	Namespace       string                           `protobuf:"bytes,7,opt,name=namespace,proto3" json:"namespace,omitempty"`                                    // Iceberg table namespace (destination database)
	Upsert          bool                             `protobuf:"varint,8,opt,name=upsert,proto3" json:"upsert,omitempty"`                                         // upsert vs append for this writer
	PartitionFields []*IcebergPayload_PartitionField `protobuf:"bytes,9,rep,name=partition_fields,json=partitionFields,proto3" json:"partition_fields,omitempty"` // partition spec at table creation
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_records_ingest_proto_rawDesc = "" +
	...
	"\x10partition_fields\x18\t \x03(\v2=.io.debezium.server.iceberg.rpc.IcebergPayload.PartitionFieldR\x0fpartitionFieldsB\x13\n" +
	...
	"\x14REFRESH_TABLE_SCHEMA\x10\x05\"p\n" +
	"\x14RecordIngestResponse\x12\x16\n" +
	"\x06result\x18\x01 \x01(\tR\x06result\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess\x12&\n" +
	"\x0folake_2pc_state\x18\x03 \x01(\tR\rolake2pcState\"\x9a\t\n" +
	"\fArrowPayload\x12L\n" +
	...
	"\tfile_path\x18\x02 \x01(\tR\bfilePath\x1a\xf5\x02\n" +
	"\bMetadata\x12&\n" +
	"\x0fdest_table_name\x18\x01 \x01(\tR\rdestTableName\x12\x1b\n" +
	"\tthread_id\x18\x02 \x01(\tR\bthreadId\x12^\n" +
	...
	"\apayload\x18\x06 \x01(\tR\apayload\x12\x1c\n" +
	"\tnamespace\x18\a \x01(\tR\tnamespace\x12\x16\n" +
	"\x06upsert\x18\b \x01(\bR\x06upsertB\x0e\n" +
	"\f_file_upload\"U\n" +
