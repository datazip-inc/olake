...
type MigrateEqualityDeletesRequest struct {
	...
	TargetMode    string `protobuf:"bytes,2,opt,name=target_mode,json=targetMode,proto3" json:"target_mode,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MigrateEqualityDeletesRequest) GetTargetMode() string {
	if x != nil {
		return x.TargetMode
	}
	return ""
...
type IcebergPayload_Metadata struct {
	...
	DeleteMode string `protobuf:"bytes,12,opt,name=delete_mode,json=deleteMode,proto3" json:"delete_mode,omitempty"`
...
func (x *IcebergPayload_Metadata) GetDeleteMode() string {
	if x != nil {
		return x.DeleteMode
	}
	return ""
