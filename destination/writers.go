...
func NewWriterPool(ctx context.Context, config *types.WriterConfig, syncStreams []string, dropStreams []types.StreamInterface, batchSize int64) (*WriterPool, error) {
